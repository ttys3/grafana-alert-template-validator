module github.com/ttys3/grafana-alert-template-validator
...
require (
	...
	github.com/grafana/grafana-aws-sdk v0.7.0 // indirect
	github.com/grafana/grafana-plugin-sdk-go v0.121.0 // indirect
